...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Categorise.Models.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Categorise.Models.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Categorise.Models.ConfigSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Categorise.Models.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Categorise.Models.TransactionNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Categorise.Models.TransactionParty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Categorise.Models.TransactionTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Categorise.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Categorise.Models.Account", b =>
                {
                    b.HasOne("Categorise.Models.User", "User")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("Categorise.Models.Transaction", b =>
                {
                    b.HasOne("Categorise.Models.Account", "Account")
                        .WithMany("Transactions")
                        .HasForeignKey("AccountForeignKey");

                    b.HasOne("Categorise.Models.Category", "Category")
                        .WithMany("Transactions")
            ...
            modelBuilder.Entity("Categorise.Models.TransactionNote", b =>
                {
                    b.HasOne("Categorise.Models.Transaction", "Transaction")
